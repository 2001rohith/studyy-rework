...
const { createCourse, getCourses, DeleteCourse, getCourse, EditCourse,
    ...
    sendEmailNotification, getModuleData, homeCourses,
} = require("../controllers/courseController")
const { CreateAssignment, GetAssignments, EditAssignment, DeleteAssignment, adminGetAssignments, adminDeleteAssignment,
    studentGetAssignments, studentsubmitAssignment, getAssignmentSubmissions,
...
const { getClasses, createClass, studentGetClasses, addClassPeerId, EditClass, deleteClass,
    setClassStatusEnded, } = require("../controllers/classController")
